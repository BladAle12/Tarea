...
class MateriaControllerTest < ActionController::TestCase
  ...
  test "should create materium" do
    assert_difference('Materium.count') do
      post :create, materium: { codigomat: @materium.codigomat, dias: @materium.dias, estatus: @materium.estatus, fechainicio: @materium.fechainicio, nombre: @materium.nombre }
    end
  ...
  test "should update materium" do
    patch :update, id: @materium, materium: { codigomat: @materium.codigomat, dias: @materium.dias, estatus: @materium.estatus, fechainicio: @materium.fechainicio, nombre: @materium.nombre }
    assert_redirected_to materium_path(assigns(:materium))
  end
